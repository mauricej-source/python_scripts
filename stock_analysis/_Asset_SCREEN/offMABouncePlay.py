...
# 
# #url = "https://elite.finviz.com/export.ashx?v=151&c=1,86,87,88,81,67&f=sh_price_o3%2Csh_relvol_o2%2Cta_change_u%2Cta_rsi_10to30&ft=4&o=-change&auth=5c4e80ff-b219-4a31-8fb8-10725a640658"
...
# 
# output_filename = f"{today_date_str}_OffMABouncePlay.csv"
# 
...
def download_OffMovingAveragesBouncePlay(url: str, output_dir: str, output_filename: str = None) -> None:
    """
